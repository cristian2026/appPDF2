sap.ui.define([
	...
	return Controller.extend("appPDF.appPDF.controller.Inicio", {
		onPress: function(){
			//var con = convertapijs.auth({secret: 'a9ATXDL8zuIod4qd'});       
			//console.log(con)
			/*var convertApi = ConvertApi.auth({secret: 'a9ATXDL8zuIod4qd'})
			var elResult = document.getElementById('result')
			var elResultLink = document.getElementById('resultLink')
        ...
        this.getView().byId("idVerticalLayout").addContent(oRichTextEditor1);
		}
	});
});